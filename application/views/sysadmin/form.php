...
<?php if ($content == 'tambah-blog'){ ?>
	<div class="row">
        <div class="col-12">
        	<div class="card">
	            <div class="card-body table-responsive">
	            	<form role="form" action="<?= site_url('sysadmin/blog/create') ?>" class="form-horizontal" data-toggle="validator" method="post" accept-charset="utf-8">
						<div class="form-group" style="margin-bottom: 5px">
							<div class="col-md-12">
								<div class="col-md-3">
									<label>JUDUL</label>
								...
								<div class="col-md-9">
									<input type="text" value="" name="judul_blog" placeholder="JUDUL BLOG" class="form-control">
								</div>
							</div>
						</div>
						<div class="form-group" style="margin-bottom: 5px">
